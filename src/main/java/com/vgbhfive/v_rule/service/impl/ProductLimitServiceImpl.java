...
public class ProductLimitServiceImpl implements ProductLimitService {
    ...
    public ResponseContent queryList(ProductQueryParam param) {
        ...
        List<ProductLimitListDto> productLimitListDtoList = Objects.isNull(lineList) || !lineList.isEmpty() ?
                productLimitMapper.queryList(param, start, limit) : new ArrayList<>();
        int totalCount = Objects.isNull(lineList) || !lineList.isEmpty() ?
                productLimitMapper.queryTotalCount(param) : 0;
