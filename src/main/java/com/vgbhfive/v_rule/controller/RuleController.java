...
public class RuleController {
    ...
    @PostMapping("/list")
    @Log
    @Permission(sign = "rule_manage", checkPermission = true, type = PermissionType.PAGE)
    ...
    @PostMapping("/create")
    @Log
    @Permission(sign = "rule_manage_create", checkPermission = true, type = PermissionType.BUTTON)
    @CheckParams(type = ElementTypes.RULE)
    ...
    @PostMapping("/update")
    @Log
    @Permission(sign = "rule_manage_update", checkPermission = true, type = PermissionType.BUTTON)
    @CheckParams(type = ElementTypes.RULE, isUpdate = true)
    ...
    @PostMapping("/valid")
    @Log
    @Permission(sign = "rule_manage_valid", checkPermission = true, type = PermissionType.BUTTON)
